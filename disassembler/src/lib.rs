...
pub fn disassemble(raw_inst: u64) -> String {
    match (raw_inst & 0b11111, (raw_inst >> 5) & 0b111) {
        (0b00000, 0b000) => r_nop("nop", raw_inst),
        ...
        (0b00100, 0b000) => i_load("lw", raw_inst),
        (0b00100, 0b001) => i_load("lh", raw_inst),
        (0b00100, 0b010) => i_load("lb", raw_inst),
        (0b00100, 0b011) => i_load("lhu", raw_inst),
        (0b00100, 0b100) => i_load("lbu", raw_inst),
