...
pub struct WidgetView<'a> {
    selected: bool,
    title: Option<String>,
    constructor: Option<Box<dyn FnOnce(Rect, &mut Buffer, bool, Option<String>) -> () + 'a>>,
}

impl<'a> ratatui::widgets::Widget for WidgetView<'a> {
...
impl<'a> WidgetView<'a> {
    pub fn selected(mut self, selected: bool) -> WidgetView<'a> {
        self.selected = selected;
        self
    }

    pub fn title(mut self, title: impl Into<String>) -> WidgetView<'a> {
        self.title = Some(title.into());
        self
    }

    pub fn body(mut self, body: impl ratatui::widgets::Widget + 'a) -> WidgetView<'a> {
